...
class AppConstants {
  static const String APP_NAME = 'SWUSHD';
  static const double APP_VERSION = 5.6;

  static const String BASE_URL = 'https://swushd.app';
  static const String CUISINES_URI = '/api/v1/cuisines/get-cuisines';
  static const String FEATURED_VENUE_URI =
      '/api/v1/featuredvenue/get-featured-venues';
  static const String RESERVATIONS_URI = '/api/v1/reservation/get-reservations';
  static const String RESERVATION_INFO_URI =
      '/api/v1/reservation/get-reservation-info';
  static const String POST_RESERVATION_URI =
      '/api/v1/reservation/post-reservation';
  static const String POST_RESERVE_PLACE_URI =
      '/api/v1/reservation/post-reserve-place';
  static const String UPDATE_RESERVATION_URI =
      '/api/v1/reservation/update-reservation';
  static const String UPDATE_RESERVATION_WITH_PAY_URI =
      '/api/v1/reservation/update-reservation-pay';
  static const String TABLES_URI = '/api/v1/reservation/get-tables';
  static const String UPDATE_TABLES_URI = '/api/v1/reservation/update-tables';
  static const String CUISINE_PRODUCT_URI = '/api/v1/cuisines/products/';
  static const String CUISINE_RESTAURANT_URI = '/api/v1/cuisines/restaurants/';
  static const String VENDOR_LIST_URI = '/api/v1/vendors/vendor-list';
  ...
  static const String CHECK_GUEST_EMAIL_PHONE_URI =
      '/api/v1/customer/check-guest-email';
  static const String VERIFY_EMAIL_URI = '/api/v1/auth/verify-email';
  static const String REGISTER_URI = '/api/v1/auth/sign-up';
  static const String SIGNUP_GUEST_URI = '/api/v1/auth/sign-up-guest';
  static const String LOGIN_URI = '/api/v1/auth/login';
  static const String LOGIN_GUEST_URI = '/api/v1/auth/login-guest';
  static const String TOKEN_URI = '/api/v1/customer/cm-firebase-token';
  static const String PLACE_ORDER_URI = '/api/v1/customer/order/place';
  static const String PLACE_RESERVE_ORDER_URI =
      '/api/v1/customer/order/place-reserve';
  static const String PLACE_RESERVE_PLACE_ORDER_URI =
      '/api/v1/customer/order/place-reserve-place';
  ...
  static const String GUEST_INFO_URI = '/api/v1/customer/guest-info';
  static const String COUPON_URI = '/api/v1/coupon/list';
  static const String COUPON_APPLY_URI = '/api/v1/coupon/apply?code=';
  static const String DELIVERY_ORDER_LIST_URI =
      '/api/v1/customer/order/running-orders';
  static const String RESERVE_ORDER_LIST_URI =
      '/api/v1/customer/order/reserve-order-list';
  ...
  static const String COMPLETE_ORDER_URI = '/api/v1/customer/order/complete';
  ...
  static const String ADD_VENDOR_WISH_LIST_URI =
      '/api/v1/customer/wish-list/add-vendor?';
  static const String REMOVE_WISH_LIST_URI =
      '/api/v1/customer/wish-list/remove?';
  static const String REMOVE_VENDOR_WISH_LIST_URI =
      '/api/v1/customer/wish-list/remove-vendor?';
  static const String NOTIFICATION_URI = '/api/v1/customer/notifications';
  static const String UPDATE_PROFILE_URI = '/api/v1/customer/update-profile';
  static const String GUEST_REGISTER_URI = '/api/v1/customer/register-guest';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(
      imageUrl: 'assets/language/fl_en.png',
    ...
    LanguageModel(
      imageUrl: 'assets/language/fl_cz.png',
      languageName: 'Czech',
    ...
    LanguageModel(
      imageUrl: 'assets/language/fl_fr.png',
      languageName: 'French',
      countryName: 'France',
      countryCode: 'FR',
      languageCode: 'fr',
    ...
    LanguageModel(
      imageUrl: 'assets/language/fl_ge.png',
      languageName: 'German',
      countryName: 'Germany',
      countryCode: 'DE',
      languageCode: 'de',
    ...
    LanguageModel(
      imageUrl: 'assets/language/fl_it.png',
    ...
    LanguageModel(
      imageUrl: 'assets/language/fl_sp.png',
    ...
    LanguageModel(
      imageUrl: 'assets/language/fl_sw.png',
