...
class PlaceOrderBody {
  ...
  PlaceOrderBody({
    ...
    this._serverTip = serverTip;
    this._serverTipMethod = serverTipMethod;
    this._promo = promo;
  ...
  PlaceOrderBody.fromJson(Map<String, dynamic> json) {
    ...
    _serviceCharge = json['service_charge'].toDouble();
    _serverTip = json['server_tip_amount'].toDouble();
    _serverTipMethod = json['server_tip_method'].toInt();
    _promo = json['promo'].toDouble();
  ...
  Map<String, dynamic> toJson(
    ...
    data['service_charge'] = this._serviceCharge;
    data['server_tip_amount'] = this._serverTip;
    data['server_tip_method'] = this._serverTipMethod;
    ...
    data['apt_number'] = aptNumber;
    data['floor'] = this._floor;
    data['address'] = this._address;
    data['dm_tips'] = this._dmTips;
    data['device_id'] = '${Get.find<UserController>().userInfoModel.deviceId}';
    return data;
  }

  Map<String, dynamic> toReserveJson(String userId) {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this._cart != null) {
      data['cart'] = this._cart.map((v) => v.toJson()).toList();
    }
