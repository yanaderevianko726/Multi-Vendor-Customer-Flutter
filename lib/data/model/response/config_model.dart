...
class BaseUrls {
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    reservationImageUrl = json['reservation_image_url'];
    tablesImageUrl = json['tables_image_url'];
    ...
    vendorAvatarUrl = 'http://swushd.app/storage/app/public/vendor';
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['cuisine_image_url'] = this.cuisineImageUrl;
    data['reservation_image_url'] = this.reservationImageUrl;
    data['tables_image_url'] = this.tablesImageUrl;
