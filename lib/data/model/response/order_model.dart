...
class OrderModel {
  ...
  OrderModel({
    ...
    this.processingTime,
    this.detailsCount,
    this.serverTipMethod = 0,
    this.serverTipAmount = 0,
    this.deliveryMan,
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    serverTipMethod = json['server_tip_method'];
    serverTipAmount = double.parse(json['server_tip_amount']);
