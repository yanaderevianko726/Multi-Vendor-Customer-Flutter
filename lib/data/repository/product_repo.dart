...
class ProductRepo extends GetxService {
  ...
  Future<Response> getPopularProductList(
    ...
    return await apiClient.getData(
      '${AppConstants.POPULAR_PRODUCT_URI}?type=$type&limit=$limit&offset=$offset',
    );
  }

  Future<Response> getReviewedProductList(
    String type,
    int limit,
    int offset,
  ) async {
    return await apiClient.getData(
      '${AppConstants.REVIEWED_PRODUCT_URI}?type=$type&limit=$limit&offset=$offset',
    );
  }
