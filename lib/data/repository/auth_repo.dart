...
class AuthRepo {
  ...
  Future<Response> loginGuest({
    String email,
    String password,
  }) async {
    return await apiClient.postData(AppConstants.LOGIN_GUEST_URI, {
      "email": email,
      "password": password,
    });
  }
  ...
  Future<Response> registerGuest(SignUpBody signUpBody) async {
    return await apiClient.postData(
      AppConstants.SIGNUP_GUEST_URI,
      signUpBody.toJson(),
    );
  }
  ...
  Future<Response> forgetPassword(String phone) async {
    return await apiClient.postData(AppConstants.FORGET_PASSWORD_URI, {
      "phone": phone,
    });
  }
