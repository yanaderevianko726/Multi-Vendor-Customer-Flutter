...
class CategoryController extends GetxController implements GetxService {
  ...
  Future<void> getCuisinesList(bool reload) async {
    Response response = await categoryRepo.getCuisinesList();
    if (response.statusCode == 200) {
      _categoryList = [];
      _interestSelectedList = [];
      response.body.forEach((category) {
  ...
  void getCategoryRestaurantList(
    ...
    Response response = await categoryRepo.getCategoryRestaurantList(
      categoryID,
      offset,
      type,
    );
