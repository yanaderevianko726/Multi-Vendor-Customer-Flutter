...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(
    () => CuisineController(
      cuisineRepo: Get.find(),
    ),
  );
  Get.lazyPut(
    () => FeaturedVenueController(
      featuredVenueRepo: Get.find(),
    ),
  );
  Get.lazyPut(
    () => ReservationController(
      reservationRepo: Get.find(),
    ),
  );
  Get.lazyPut(
    () => CuisineRepo(
  ...
  Get.lazyPut(
    () => VendorController(vendorRepo: Get.find()),
  );
  Get.lazyPut(
    () => WishListController(
      wishListRepo: Get.find(),
      productRepo: Get.find(),
    ),
  );
  Get.lazyPut(
