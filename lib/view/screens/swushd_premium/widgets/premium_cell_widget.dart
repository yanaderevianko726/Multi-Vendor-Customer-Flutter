...
class PremiumCellWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double rightWidth = (cellWidth - hPadding * 2) / 2 - 20;
    ...
    double _cellHeight =
        cellHeight != null ? cellHeight : Dimensions.HEIGHT_OF_CHEF_CELL + 20;

    var venueType = restaurant.venueType == 0
        ? '${'Cafe'.tr}'
        : restaurant.venueType == 1
            ? '${'Co-Work Hub'.tr}'
            : restaurant.venueType == 2
                ? '${'Hotel'.tr}'
                : restaurant.venueType == 3
                    ? '${'Lounge'.tr}'
                    : restaurant.venueType == 4
