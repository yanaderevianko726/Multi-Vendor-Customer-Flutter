...
import 'package:efood_multivendor/view/base/venues_new_widget.dart';
...
class NewVenuesScreen extends StatefulWidget {
  const NewVenuesScreen({Key key}) : super(key: key);
  @override
  State<NewVenuesScreen> createState() => _NewVenuesScreenState();
}

class _NewVenuesScreenState extends State<NewVenuesScreen> {
      ...
      body: GetBuilder<RestaurantController>(builder: (restaurantController) {
        ...
        if (restaurantController.restaurantModel != null &&
          ...
          restaurantController.restaurantModel.restaurants.forEach((element) {
            if (element.isNew == 1 && element.venueType == 0) {
