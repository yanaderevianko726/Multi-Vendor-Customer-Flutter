                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      (widget.address.house != null &&
                                          ...
                                          ? Text(
                                              '${widget.address.house}, ${widget.address.road}',
                                              style: robotoMedium)
                                          : SizedBox.shrink(),
                                      (widget.address.aptNumber != null &&
                                              widget.address.villageName.isNotEmpty &&
                                          widget.address.floor.isNotEmpty)
                                          ? Text(
                                              '${widget.address.aptNumber}, ${widget.address.villageName}, ${widget.address.floor}',
                                              style: robotoMedium)
                                          : SizedBox.shrink(),
