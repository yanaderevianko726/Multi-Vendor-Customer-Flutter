...
class ReserveCartScreen extends StatefulWidget {
  final fromNav;
  ReserveCartScreen({
  ...
  @override
  State<ReserveCartScreen> createState() => _ReserveCartScreenState();
}

class _ReserveCartScreenState extends State<ReserveCartScreen> {
  @override
