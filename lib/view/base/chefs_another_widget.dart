...
class ChefsAnotherWidget extends StatelessWidget {
  final Vendor vendor;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CuisineController>(builder: (cuisineController) {
      return GetBuilder<LocationController>(builder: (locationController) {
        var imgRestUrlPrefix = '${_baseUrls.restaurantImageUrl}/';
        ...
        if (restIndex != -1) {
          ...
          print('cuisines: ${cuisineController.cuisinesList.length}');
          if (cuisineController.allCuisinesList != null) {
            if (cuisineController.allCuisinesList.isNotEmpty) {
              cuisineController.allCuisinesList.forEach((cuisine) {
                if (cuisine.id == restaurant.cuisineId) {
                  restCuisineName = cuisine.name;
                }
              });
            }
          }
                                ...
                                (restaurant.coverPhoto != null &&
                                    ...
                                    ? Stack(
                                        children: [
                                          CustomImage(
                                            image:
                                                '$imgRestUrlPrefix${restaurant.logo}',
